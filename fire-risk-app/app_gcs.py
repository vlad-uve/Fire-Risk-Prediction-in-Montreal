# app_gcs.py – using GOOGLE_APPLICATION_CREDENTIALS from Render Secret File
...
def show_maps():
    try:
        ...
        if selected_month == DEFAULT_MONTH:
            ...
            # Predict and generate map dynamically
